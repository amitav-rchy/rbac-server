...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('USER_CREATED', 'USER_UPDATED', 'USER_BANNED', 'USER_SUSPENDED', 'USER_ACTIVATED', 'USER_PASSWORD_RESET', 'PERMISSION_GRANTED', 'PERMISSION_REVOKED', 'ROLE_CHANGED', 'LOGIN', 'LOGOUT', 'REFRESH_TOKEN');
